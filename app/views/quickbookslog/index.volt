<div class="page-header">
    ...
    <p>
        {{ link_to("quickbookslog/new", "Create quickbooks_log") }}
    </p>
</div>

{{ content() }}

{{ form("quickbookslog/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}

<div class="form-group">
    <label for="fieldQuickbooksLogId" class="col-sm-2 control-label">Quickbooks Of Log</label>
    <div class="col-sm-10">
        {{ text_field("quickbooks_log_id", "type" : "numeric", "class" : "form-control", "id" : "fieldQuickbooksLogId") }}
    </div>
</div>
