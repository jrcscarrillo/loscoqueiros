<div class="page-header">
    <h1>
        Search invoicelinedetail
    </h1>
    <p>
        {{ link_to("invoicelinedetail/new", "Create invoicelinedetail") }}
    </p>
</div>

{{ content() }}

{{ form("invoicelinedetail/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
